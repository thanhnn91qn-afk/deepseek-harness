...
export const vi: { [Key in keyof typeof en]: string } = {
  nav: 'Mô hình',
  title: 'Mô hình',
  intro: 'Nhập khóa API để sử dụng mô hình từ các nhà cung cấp dưới đây.',
  edit: 'Sửa',
  editProvider: 'Sửa {provider}',
  remove: 'Xóa',
  removeProvider: 'Xóa {provider}',
  deleteTitle: 'Xóa {provider}?',
  deleteDescription: 'Xóa {provider} sẽ gỡ bỏ cấu hình của nó; khóa xác thực (nếu có) do nơi khác quản lý sẽ vẫn được giữ lại.',
  deleteDescriptionWithCredential: 'Xóa {provider} sẽ gỡ bỏ cấu hình và khóa API đã lưu của nó.',
  ...
  readOnly: 'Tài liệu cài đặt ở chế độ chỉ đọc trong triển khai này.',
  loadFailed: 'Tải danh mục nhà cung cấp thất bại',
  conflict: 'Cài đặt này đã bị thay đổi ở nơi khác trong lúc thẻ này đang mở. Hãy đóng và mở lại để chỉnh sửa trên giá trị hiện tại.',
  retry: 'Thử lại',
  keyInput: 'Khóa API',
  ...
  modelNamePlaceholder: 'Dùng Model ID nếu để trống',
  ...
  modelsEmpty: 'Sẽ không có mô hình nào hiển thị trong bộ chọn. Các ID không nằm trong danh mục vẫn có thể được gửi trực tiếp.',
  ...
  advancedHint: 'Các trường khác nằm trong settings.yaml; hãy chỉnh sửa trực tiếp ở phần đó.',
  modelCapacityInvalid: 'Năng lực phải là một số, có thể kèm hậu tố K hoặc M.',
  ...
  fetchNeedsBaseUrl: 'Hãy nhập Base URL trước, sau đó lấy danh sách.',
  fetchEmpty: 'Nhà cung cấp không liệt kê mô hình nào. Hãy thêm thủ công.',
  fetchTitle: 'Chọn mô hình để thêm',
  fetchDescription: 'Đây là các mô hình mà nhà cung cấp này hiện có. Hãy chọn những mô hình cần thêm.',
  fetchAdopt: 'Thêm mục đã chọn',
  customAdd: 'Thêm nhà cung cấp tùy chỉnh',
  customTitle: 'Nhà cung cấp tùy chỉnh',
  customTag: 'Tùy chỉnh',
  customRoute: 'Provider ID',
  customRouteHint: 'Định danh viết thường, bắt đầu bằng chữ cái, dùng để xác định duy nhất nhà cung cấp này trong các yêu cầu và làm tên khóa xác thực.',
  customRouteInvalid: 'Phải bắt đầu bằng chữ thường; sau đó chỉ gồm chữ thường, số và dấu gạch ngang.',
  customRouteTaken: 'Đã có nhà cung cấp khác dùng ID này.',
