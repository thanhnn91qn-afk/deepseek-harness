...
export const vi = {
  'row.defineTitle': 'Đăng ký Cordis Plugin',
  'row.runTitle': 'Chạy Cordis Plugin',
  'row.updateTitle': 'Cập nhật Cordis Plugin',
  'row.stopTitle': 'Dừng Cordis Plugin',
  'row.removeTitle': 'Gỡ Cordis Plugin',
  'purpose.missing': '(chưa nhập mục đích)',
  'status.idle': 'Sẵn sàng',
  'status.awaitingApproval': 'Chờ phê duyệt',
  'status.failed': 'Chạy thất bại',
  'status.clientPending': 'Client chờ kích hoạt',
  'status.running': 'Đang chạy',
  'status.removed': 'Đã gỡ',
  'status.superseded': 'Có bản cập nhật mới',
  'run.removed': 'Gói này không còn tồn tại',
  'run.superseded': 'Có thẻ chạy mới hơn ở bên dưới',
  'panel.hint': 'Điều khiển chạy nằm trong bảng Cordis phía trên Cài đặt',
  ...
  'render.failedAbdicated': 'Hiển thị {slot} thất bại, đã khôi phục giao diện mặc định:',
  'render.failedHeld': 'Hiển thị {slot} thất bại:',
